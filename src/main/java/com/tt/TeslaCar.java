...
public class TeslaCar {
    ...
    public TeslaCar(String condition, Map map) {
        ...
        try { this.currencyCode = (String) map.get("CurrencyCode"); }
    ...
    public boolean equals(Object o) {
        ...
        return odometer == teslaCar.odometer &&
            ...
            country.equals(teslaCar.country) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(country, model, autopilot, city, currencyCode, interior, odometer, odometerType, paint, trim, wheels, year, isDemo, condition);
    }
    ...
    public static void main(String[] args) throws ParseException {
        ...
        TeslaInventoryGrepper.parse("new", str, cars);
